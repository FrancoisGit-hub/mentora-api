...
/// Identifier of the voucher this session was booked from, or null for a group session — a group
/// session has no single voucher; see GET .../participants for per-member vouchers.
/// </param>
...
/// <param name="OfferType">Session format: VISIO, PRESENTIEL_SOLO, PRESENTIEL_GROUPE, or VISIO_GROUPE.</param>
...
/// </param>
/// <param name="MaxParticipants">Group sessions only: capacity snapshotted at creation. Null means no limit or an individual session.</param>
